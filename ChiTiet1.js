  ...
  return (
    <View style={styles.container}>
      ...
      <View style= {styles.view3}>
       <View>
        <View>
        <Text style={styles.tex1}>Gà Nướng Muối Ớt</Text>
        </View>
        <View>
         <Text style={styles.text}>Điểm cộng: Gà nướng ngon, nóng, tẩm ướp đậm đà,      {'\n'}chất lượng ổn định.</Text>
       </View>
       </View>    
      <View style={styles.viewhat}>
       <View>
       <Image style={styles.imagehatcf} source={require('../images/loga3.webp')}/>
        </View>
        <View>
        <Image style={styles.imagehatcf} source={require('../images/logoga2.jpg')}/>
       </View>
      </View>
      </View>
      <View style= {styles.view3}>
